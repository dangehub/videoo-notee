...
`}=o;return e.map(r=>n?`[${this.formatTime(r.start)}] ${r.text}`:r.text).join(i)}formatTime(e){let o=Math.floor(e/1e3),n=Math.floor(o/3600),i=Math.floor(o%3600/60),r=o%60;return n>0?`${n}:${i.toString().padStart(2,"0")}:${r.toString().padStart(2,"0")}`:`${i}:${r.toString().padStart(2,"0")}`}},W=class{constructor(){this.providers=new Map}registerProvider(e,o){this.providers.set(e,o)}getProvider(e){return this.providers.get(e)||null}detectProvider(e){for(let[o,n]of this.providers)if(n.matchUrl&&n.matchUrl(e))return n;return null}},D=new W;var P=class extends L{constructor(e={}){super(e),this.platform="youtube"}matchUrl(e){return/youtube\.com|youtu\.be/i.test(e)}async getAvailableSubtitles(){var n,i;let e=this.getPlayerResponse();if(!e)return[];let o=(i=(n=e==null?void 0:e.captions)==null?void 0:n.playerCaptionsTracklistRenderer)==null?void 0:i.captionTracks;return o?o.map(r=>{var a;return{id:r.baseUrl,language:r.languageCode,label:((a=r.name)==null?void 0:a.simpleText)||r.languageCode,isAuto:r.kind==="asr"}}):[]}async getSubtitle(e){try{let n=await(await fetch(e)).text();return this.parseToCommon(n)}catch(o){return console.error("[Videoo Notee] YouTube \u5B57\u5E55\u83B7\u53D6\u5931\u8D25:",o),[]}}async getCurrentSubtitle(){let e=document.querySelector(".ytp-caption-window-container");if(e){let o=e.querySelectorAll(".ytp-caption-segment");return Array.from(o).map(n=>n.textContent).join(" ")}return""}parseToCommon(e){let i=new DOMParser().parseFromString(e,"text/xml").querySelectorAll("text");return Array.from(i).map(r=>{let a=parseFloat(r.getAttribute("start"))*1e3,c=parseFloat(r.getAttribute("dur")||"0")*1e3;return{start:a,end:a+c,text:this.decodeHtmlEntities(r.textContent||"")}})}getPlayerResponse(){var o;if(window.ytInitialPlayerResponse)return window.ytInitialPlayerResponse;let e=document.getElementsByTagName("script");for(let n of e){let i=(o=n.textContent)==null?void 0:o.match(/ytInitialPlayerResponse\s*=\s*({.+?});/);if(i)try{return JSON.parse(i[1])}catch{continue}}return null}decodeHtmlEntities(e){let o=document.createElement("textarea");return o.innerHTML=e,o.value}};var O=class extends L{constructor(e={}){super(e),this.platform="bilibili"}matchUrl(e){return/bilibili\.com|b23\.tv/i.test(e)}async getAvailableSubtitles(){var i,r;let e=this.getVideoInfo();if(!e)return[];let{aid:o,cid:n}=e;try{let c=await(await fetch(`https://api.bilibili.com/x/player/v2?aid=${o}&cid=${n}`,{credentials:"include"})).json();return c.code!==0||!((r=(i=c.data)==null?void 0:i.subtitle)!=null&&r.subtitles)?[]:c.data.subtitle.subtitles.map(d=>({id:d.subtitle_url,language:d.lan,label:d.lan_doc,isAuto:d.ai_type>0}))}catch(a){return console.error("[Videoo Notee] B\u7AD9\u5B57\u5E55\u5217\u8868\u83B7\u53D6\u5931\u8D25:",a),[]}}async getSubtitle(e){try{let o=e.startsWith("http")?e:`https:${e}`,i=await(await fetch(o)).json();return this.parseToCommon(i)}catch(o){return console.error("[Videoo Notee] B\u7AD9\u5B57\u5E55\u83B7\u53D6\u5931\u8D25:",o),[]}}async getCurrentSubtitle(){let e=document.querySelector(".bpx-player-subtitle-panel-text");return e&&e.textContent||""}parseToCommon(e){return e!=null&&e.body?e.body.map(o=>({start:o.from*1e3,end:o.to*1e3,text:o.content})):[]}getVideoInfo(){var r,a,c,d,l;if(window.__INITIAL_STATE__){let s=window.__INITIAL_STATE__;return{aid:s.aid||((r=s.videoData)==null?void 0:r.aid),bvid:s.bvid||((a=s.videoData)==null?void 0:a.bvid),cid:s.cid||((c=s.videoData)==null?void 0:c.cid)}}let o=window.location.href.match(/BV[\w]+/i),n=o?o[0]:null,i=document.getElementsByTagName("script");for(let s of i){let u=(d=s.textContent)==null?void 0:d.match(/"aid"\s*:\s*(\d+)/),m=(l=s.textContent)==null?void 0:l.match(/"cid"\s*:\s*(\d+)/);if(u&&m)return{aid:u[1],cid:m[1],bvid:n}}return null}};var h=null,K=null,V={assetsFolder:"assets"};async function ae(){try{let t=await Pe();if(t&&await t.queryPermission({mode:"readwrite"})==="granted")return h=t,await X(),console.log("[Videoo Notee] \u5DF2\u6062\u590D\u4FDD\u5B58\u76EE\u5F55\u6743\u9650"),!0}catch(t){console.log("[Videoo Notee] \u65E0\u6CD5\u6062\u590D\u76EE\u5F55\u6743\u9650:",t)}return!1}async function ce(){try{return h=await window.showDirectoryPicker({mode:"readwrite",startIn:"documents"}),await De(h),await X(),console.log("[Videoo Notee] \u5DF2\u9009\u62E9\u4FDD\u5B58\u76EE\u5F55:",h.name),!0}catch(t){if(t.name==="AbortError")return console.log("[Videoo Notee] \u7528\u6237\u53D6\u6D88\u9009\u62E9\u76EE\u5F55"),!1;throw console.error("[Videoo Notee] \u9009\u62E9\u76EE\u5F55\u5931\u8D25:",t),t}}async function X(){if(h)try{let t=await ge();K=await h.getDirectoryHandle(t.assetsFolder||V.assetsFolder,{create:!0}),console.log("[Videoo Notee] Assets \u6587\u4EF6\u5939\u5DF2\u5C31\u7EEA")}catch(t){console.error("[Videoo Notee] \u521B\u5EFA assets \u6587\u4EF6\u5939\u5931\u8D25:",t)}}async function le(t,e){if(!h)throw new Error("\u8BF7\u5148\u9009\u62E9\u4FDD\u5B58\u76EE\u5F55");try{let o=ve(t)+".md",i=await(await h.getFileHandle(o,{create:!0})).createWritable();return await i.write(e),await i.close(),console.log("[Videoo Notee] \u7B14\u8BB0\u5DF2\u4FDD\u5B58:",o),o}catch(o){throw console.error("[Videoo Notee] \u4FDD\u5B58\u7B14\u8BB0\u5931\u8D25:",o),o}}async function de(t,e){if(!K)throw new Error("\u8BF7\u5148\u9009\u62E9\u4FDD\u5B58\u76EE\u5F55");try{let n=await(await fetch(t)).blob(),i=t.includes("image/png")?".png":".jpg",r=ve(e)+i,c=await(await K.getFileHandle(r,{create:!0})).createWritable();await c.write(n),await c.close();let l=(await ge()).assetsFolder||V.assetsFolder;return console.log("[Videoo Notee] \u622A\u56FE\u5DF2\u4FDD\u5B58:",r),`${l}/${r}`}catch(o){throw console.error("[Videoo Notee] \u4FDD\u5B58\u622A\u56FE\u5931\u8D25:",o),o}}async function ue(){if(!h)return[];let t=[];try{for await(let e of h.values())if(e.kind==="file"&&e.name.endsWith(".md")){let o=await e.getFile();t.push({name:e.name,title:e.name.replace(".md",""),lastModified:o.lastModified})}t.sort((e,o)=>o.lastModified-e.lastModified)}catch(e){console.error("[Videoo Notee] \u5217\u51FA\u7B14\u8BB0\u5931\u8D25:",e)}return t}async function pe(t){if(!h)throw new Error("\u8BF7\u5148\u9009\u62E9\u4FDD\u5B58\u76EE\u5F55");try{return await(await(await h.getFileHandle(t)).getFile()).text()}catch(e){throw console.error("[Videoo Notee] \u8BFB\u53D6\u7B14\u8BB0\u5931\u8D25:",e),e}}async function fe(t){if(!h)throw new Error("\u672A\u9009\u62E9\u76EE\u5F55");try{let e=t.split("/"),o=h;for(let r=0;r<e.length-1;r++)o=await o.getDirectoryHandle(e[r]);let n=e[e.length-1];return await(await o.getFileHandle(n)).getFile()}catch(e){return console.error("[Videoo Notee] \u8BFB\u53D6\u8D44\u6E90\u5931\u8D25:",t,e),null}}function me(){return h!==null}function N(){return(h==null?void 0:h.name)||null}function ve(t){return t.replace(/[<>:"/\\|?*]/g,"_").replace(/\s+/g,"_").substring(0,200)}var Fe="videoo-notee-fs",Be=1,T="handles";function he(){return new Promise((t,e)=>{let o=indexedDB.open(Fe,Be);o.onerror=()=>e(o.error),o.onsuccess=()=>t(o.result),o.onupgradeneeded=n=>{let i=n.target.result;i.objectStoreNames.contains(T)||i.createObjectStore(T)}})}async function De(t){try{let o=(await he()).transaction(T,"readwrite");o.objectStore(T).put(t,"rootDir"),await o.complete}catch(e){console.error("[Videoo Notee] \u4FDD\u5B58\u76EE\u5F55\u53E5\u67C4\u5931\u8D25:",e)}}async function Pe(){try{let o=(await he()).transaction(T,"readonly").objectStore(T);return new Promise((n,i)=>{let r=o.get("rootDir");r.onsuccess=()=>n(r.result),r.onerror=()=>i(r.error)})}catch(t){return console.error("[Videoo Notee] \u83B7\u53D6\u76EE\u5F55\u53E5\u67C4\u5931\u8D25:",t),null}}async function ge(){try{return(await chrome.storage.local.get("fileSystemConfig")).fileSystemConfig||V}catch{return V}}async function be(t){try{await chrome.storage.local.set({fileSystemConfig:{...V,...t}}),t.assetsFolder&&h&&await X()}catch(e){console.error("[Videoo Notee] \u4FDD\u5B58\u914D\u7F6E\u5931\u8D25:",e)}}var g=null;function Oe(t){g&&g.remove(),g=document.createElement("div"),g.className="vn-directory-dialog-overlay";let e=g.attachShadow({mode:"open"}),o=document.createElement("style");o.textContent=qe(),e.appendChild(o);let n=document.createElement("div");n.className="vn-dialog",n.innerHTML=`
    ...
    `,e.appendChild(n),document.body.appendChild(g);let i=e.getElementById("folder-path"),r=e.getElementById("btn-select-folder"),a=e.getElementById("assets-folder"),c=e.getElementById("btn-cancel"),d=e.getElementById("btn-confirm"),l=!1,s=async()=>{try{await ce()&&(l=!0,i.textContent=N(),i.classList.add("selected"),d.disabled=!1,d.textContent="\u786E\u8BA4")}catch(m){console.error("\u9009\u62E9\u76EE\u5F55\u5931\u8D25:",m),i.textContent="\u9009\u62E9\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5"}};r.addEventListener("click",s),i.addEventListener("click",s),c.addEventListener("click",()=>{g.remove(),g=null,t&&t(!1)}),d.addEventListener("click",async()=>{if(!l)return;let m=a.value.trim()||"assets";await be({assetsFolder:m}),g.remove(),g=null,t&&t(!0)});let u=m=>{m.key==="Escape"&&(g.remove(),g=null,document.removeEventListener("keydown",u),t&&t(!1))};document.addEventListener("keydown",u)}async function G(){return me()?!0:new Promise(t=>{Oe(t)})}function qe(){return`
        * {
            margin: 0;
            padding: 0;
    ...
    `}var w=null;async function xe(t){w&&w.remove();let e=await ue();w=document.createElement("div"),w.className="vn-file-dialog-overlay";let o=w.attachShadow({mode:"open"}),n=document.createElement("style");n.textContent=Re(),o.appendChild(n);let i=document.createElement("div");i.className="vn-dialog",i.innerHTML=`
        <div class="vn-dialog-header">
            <h2>\u6253\u5F00\u7B14\u8BB0</h2>
    ...
    `,o.appendChild(i),document.body.appendChild(w);let r=(s="")=>{let u=o.getElementById("file-list");u.innerHTML="";let m=e.filter(b=>b.title.toLowerCase().includes(s.toLowerCase()));if(m.length===0){u.innerHTML='<div class="vn-empty-state">\u6CA1\u6709\u627E\u5230\u6587\u4EF6</div>';return}m.forEach(b=>{let k=document.createElement("div");k.className="vn-file-item";let re=new Date(b.lastModified),Ie=re.toLocaleDateString()+" "+re.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});k.innerHTML=`
                <div class="vn-file-info">
                    <div class="vn-file-title">${b.title}</div>
                    <div class="vn-file-date">${Ie}</div>
                </div>
                <button class="vn-btn-open">\u6253\u5F00</button>
            `,k.addEventListener("click",()=>{d(),t&&t(b)}),u.appendChild(k)})};r();let a=o.getElementById("file-search"),c=o.querySelector(".vn-btn-close");a.addEventListener("input",s=>{r(s.target.value)});let d=()=>{w.remove(),w=null,document.removeEventListener("keydown",l)};c.addEventListener("click",d);let l=s=>{s.key==="Escape"&&d()};document.addEventListener("keydown",l),setTimeout(()=>a.focus(),100)}function Re(){return`
        * {
            margin: 0;
            padding: 0;
            box-sizing: border-box;
    ...
    `}var f=null,te=!1,J=!1,Q=!1,q={x:0,y:0},C="",E="",R={width:420,height:500,right:20,top:80};async function He(){if(f)return H(),f;if(!await ae()&&!await G())return console.log("[Videoo Notee] \u7528\u6237\u53D6\u6D88\u9009\u62E9\u76EE\u5F55"),null;let e=document.createElement("div");e.id="videoo-notee-floating-editor",e.className="vn-floating-editor";let o=e.attachShadow({mode:"open"}),n=document.createElement("style");n.textContent=et(),o.appendChild(n),E=oe();let i=document.createElement("div");return i.className="vn-editor-wrapper",i.innerHTML=`
        <div class="vn-editor-header">
            ...
            <div class="vn-header-controls">
                <span class="vn-save-status" title="\u4FDD\u5B58\u76EE\u5F55">\u{1F4C1} ${N()||"\u672A\u9009\u62E9"}</span>
    ...
    `,o.appendChild(i),i.style.width=R.width+"px",i.style.height=R.height+"px",i.style.right=R.right+"px",i.style.top=R.top+"px",Ue(o,i),document.body.appendChild(e),f={container:e,shadow:o,wrapper:i,liveEditor:o.querySelector(".vn-live-editor"),screenshotsList:o.querySelector(".vn-screenshots-list"),screenshots:[],content:""},te=!0,f}function Ue(t,e){let o=t.querySelector(".vn-drag-handle"),n=t.querySelector(".vn-btn-close"),i=t.querySelector(".vn-btn-minimize"),r=t.querySelector(".vn-btn-focus"),a=t.querySelectorAll(".vn-resize-handle"),c=t.querySelectorAll(".vn-tool-btn");o.addEventListener("mousedown",s=>{J=!0;let u=e.getBoundingClientRect();q.x=s.clientX-u.left,q.y=s.clientY-u.top,e.classList.add("vn-dragging"),s.preventDefault()}),document.addEventListener("mousemove",s=>{if(J){let u=s.clientX-q.x,m=s.clientY-q.y;e.style.left=Math.max(0,u)+"px",e.style.top=Math.max(0,m)+"px",e.style.right="auto"}Q&&je(s,e)}),document.addEventListener("mouseup",()=>{J=!1,Q=!1,C="",e.classList.remove("vn-dragging"),e.classList.remove("vn-resizing")}),a.forEach(s=>{s.addEventListener("mousedown",u=>{Q=!0,C=s.dataset.dir,e.classList.add("vn-resizing"),u.preventDefault(),u.stopPropagation()})}),n.addEventListener("click",Ge),i.addEventListener("click",()=>{e.classList.toggle("vn-minimized")}),r.addEventListener("click",()=>{window.postMessage({type:"VN_ENTER_FOCUS_MODE"},"*")}),c.forEach(s=>{s.addEventListener("click",()=>{let u=s.dataset.action;Ye(u)})});let d=t.querySelector(".vn-live-editor");d.addEventListener("input",()=>{f&&(f.content=d.innerHTML,we())}),d.addEventListener("keydown",s=>{s.stopPropagation()}),d.addEventListener("keyup",s=>{s.stopPropagation()}),d.addEventListener("keypress",s=>{s.stopPropagation()});let l=t.querySelector(".vn-note-title");l&&(l.addEventListener("input",Ze),l.addEventListener("blur",()=>{l.value.trim()||(l.value=oe(),E=l.value)}),l.addEventListener("keydown",s=>{s.stopPropagation()}),l.addEventListener("keyup",s=>{s.stopPropagation()}))}function je(t,e){let o=e.getBoundingClientRect(),n=320,i=300,r=o.width,a=o.height,c=o.left,d=o.top;if(C.includes("e")&&(r=Math.max(n,t.clientX-o.left)),C.includes("w")){let l=o.left-t.clientX;r=Math.max(n,o.width+l),r>n&&(c=t.clientX)}if(C.includes("s")&&(a=Math.max(i,t.clientY-o.top)),C.includes("n")){let l=o.top-t.clientY;a=Math.max(i,o.height+l),a>i&&(d=t.clientY)}e.style.width=r+"px",e.style.height=a+"px",e.style.left=c+"px",e.style.top=d+"px",e.style.right="auto"}async function Ye(t){switch(t){case"screenshot":window.postMessage({type:"VN_CAPTURE_SCREENSHOT"},"*");break;case"timestamp":Xe();break;case"open":xe(async e=>{try{let o=await pe(e.name);if(f&&f.liveEditor){E=e.title;let n=f.shadow.querySelector(".vn-note-title");n&&(n.value=E),f.liveEditor.innerHTML=Qe(o),console.log("[Videoo Notee] \u5DF2\u6253\u5F00\u7B14\u8BB0:",e.name);let i=f.liveEditor.querySelectorAll("img");for(let r of i){let a=r.getAttribute("data-saved-path")||r.getAttribute("src");if(a&&!a.match(/^(http|https|blob|data):/))try{let c=await fe(a);if(c){let d=URL.createObjectURL(c);r.src=d,r.getAttribute("data-saved-path")||r.setAttribute("data-saved-path",a)}}catch{console.warn("\u65E0\u6CD5\u52A0\u8F7D\u56FE\u7247\u8D44\u6E90:",a)}}}}catch(o){console.error("[Videoo Notee] \u6253\u5F00\u7B14\u8BB0\u5931\u8D25:",o)}});break;case"save":await Ee();break;case"folder":await G(),ee();break}}function We(t,e){try{let o=new URL(t);return o.searchParams.set("t",Math.floor(e).toString()),o.toString()}catch{let n=t.includes("?")?"&":"?";return`${t}${n}t=${Math.floor(e)}`}}async function ye(t,e,o){if(!f)return;let n=Se(e),i=`screenshot_${Date.now()}`,r=i;try{r=await de(t,i),console.log("[Videoo Notee] \u622A\u56FE\u5DF2\u4FDD\u5B58:",r)}catch(s){console.error("[Videoo Notee] \u4FDD\u5B58\u622A\u56FE\u5931\u8D25:",s)}let a={id:`ss_${Date.now()}`,dataUrl:t,savedPath:r,timestamp:e,videoUrl:o,createdAt:Date.now()};f.screenshots.push(a);let c=We(o,e),d=`<div class="vn-screenshot-block" data-path="${r}"><img src="${t}" alt="\u622A\u56FE ${n}" class="vn-screenshot-img" data-saved-path="${r}"><a href="${c}" class="vn-timestamp-link">${n}</a></div>`,l=f.liveEditor;l.insertAdjacentHTML("beforeend",d),l.scrollTop=l.scrollHeight,Ke(),we()}function Ke(){if(!f)return;let t=f.screenshotsList;t.innerHTML=f.screenshots.map((e,o)=>`
        <img src="${e.dataUrl}" 
             class="vn-screenshot-thumb" 
             data-index="${o}"
             title="${Se(e.timestamp)}">
    `).join("")}function Xe(){window.postMessage({type:"VN_GET_TIMESTAMP"},"*")}var Z=null;function we(){Z&&clearTimeout(Z),Z=setTimeout(()=>{Ee()},2e3)}async function Ee(){if(f)try{let t=Je(f.liveEditor);await le(E,t),ee("\u5DF2\u4FDD\u5B58"),console.log("[Videoo Notee] \u7B14\u8BB0\u5DF2\u4FDD\u5B58:",E)}catch(t){console.error("[Videoo Notee] \u4FDD\u5B58\u7B14\u8BB0\u5931\u8D25:",t),ee("\u4FDD\u5B58\u5931\u8D25")}}function H(){if(!f){He();return}f.container.style.display="block",te=!0}function Ge(){f&&(f.container.style.display="none",te=!1)}function Se(t){if(!t&&t!==0)return"--:--";let e=Math.floor(t/3600),o=Math.floor(t%3600/60),n=Math.floor(t%60);return e>0?`${e}:${o.toString().padStart(2,"0")}:${n.toString().padStart(2,"0")}`:`${o}:${n.toString().padStart(2,"0")}`}function oe(){let e=new Date().toISOString().slice(0,10),n=(document.title||"Untitled").replace(/[<>:"/\\|?*]/g,"").replace(/\s+/g," ").trim().substring(0,100);return`${e} ${n}`}function ee(t){if(!f)return;let e=f.shadow.querySelector(".vn-save-status");e&&(t?(e.textContent=`\u2713 ${t}`,e.classList.add("saved"),setTimeout(()=>{e.textContent=`\u{1F4C1} ${N()||"\u672A\u9009\u62E9"}`,e.classList.remove("saved")},2e3)):e.textContent=`\u{1F4C1} ${N()||"\u672A\u9009\u62E9"}`)}function Je(t){let e="";function o(n){if(n.nodeType===Node.TEXT_NODE)return n.textContent;if(n.nodeType!==Node.ELEMENT_NODE)return"";let i=n.tagName.toLowerCase(),r="";for(let a of n.childNodes)r+=o(a);switch(i){case"div":if(n.classList.contains("vn-screenshot-block")){let l=n.querySelector("img"),s=n.querySelector(".vn-timestamp-link"),u=(l==null?void 0:l.dataset.savedPath)||(l==null?void 0:l.src)||"",m=(s==null?void 0:s.textContent)||"",b=(s==null?void 0:s.href)||"",k=`![\u622A\u56FE ${m}](${u})
`;return b&&(k+=`[${m}](${b})
`),k+`
`}return r+`
`;case"p":return r+`
...
`).trim()}function Qe(t){if(!t)return"";let e=t,o=[];e=e.replace(/```([\s\S]*?)```/g,(i,r)=>(o.push(r),`__CODE_BLOCK_${o.length-1}__`));let n=/!\[(.*?)\]\((.*?)\)\s*(?:\[(.*?)\]\((.*?)\))?/g;return e=e.replace(n,(i,r,a,c,d)=>{if(r.includes("\u622A\u56FE")||a.includes("assets/")){let s="";return c&&d&&(s=`<a href="${d}" class="vn-timestamp-link">${c}</a>`),`<div class="vn-screenshot-block" data-path="${a}"><img src="${a}" alt="${r}" class="vn-screenshot-img" data-saved-path="${a}">${s}</div>`}return`<img src="${a}" alt="${r}">`}),e=e.replace(/\[(.*?)\]\((.*?)\)/g,'<a href="$2">$1</a>'),e=e.replace(/^### (.*$)/gm,"<h3>$1</h3>"),e=e.replace(/^## (.*$)/gm,"<h2>$1</h2>"),e=e.replace(/^# (.*$)/gm,"<h1>$1</h1>"),e=e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*(.*?)\*/g,"<em>$1</em>"),e=e.replace(/^\- (.*$)/gm,"<li>$1</li>"),e=e.replace(/(<li>.*<\/li>)/g,"<ul>$1</ul>"),e=e.replace(/\n\n/g,"<br><br>"),e=e.replace(/\n/g,"<br>"),e=e.replace(/__CODE_BLOCK_(\d+)__/g,(i,r)=>`<pre><code>${o[r]}</code></pre>`),e}function Ze(t){E=t.target.value||oe()}function et(){return`
        * {
            margin: 0;
            padding: 0;
            box-sizing: border-box;
    ...
    `}var M=!1,S=null,y=null,ke={bilibili:[".bpx-player-container","#bilibili-player",".bilibili-player-area"],youtube:["#movie_player","ytd-player",".html5-video-player"],generic:['[class*="player"]','[class*="video-container"]','[id*="player"]']};function tt(){let t=window.location.hostname;return t.includes("bilibili.com")?"bilibili":t.includes("youtube.com")||t.includes("youtu.be")?"youtube":t.includes("coursera.org")?"coursera":t.includes("udemy.com")?"udemy":"generic"}function ot(){let t=tt(),e=ke[t]||ke.generic;for(let n of e){let i=document.querySelector(n);if(i&&nt(i))return console.log(`[Videoo Notee] \u627E\u5230\u64AD\u653E\u5668: ${n}`),i}let o=document.querySelector("video");if(o){let n=o.parentElement;for(;n&&n!==document.body;){let i=n.getBoundingClientRect();if(i.width>=300&&i.height>=200)return console.log("[Videoo Notee] \u4F7F\u7528 video \u7236\u5BB9\u5668"),n;n=n.parentElement}return o}return null}function nt(t){let e=t.getBoundingClientRect();return e.width>=200&&e.height>=100&&window.getComputedStyle(t).display!=="none"}function ne(){if(M){console.log("[Videoo Notee] \u5DF2\u5728\u89C6\u9891\u6A21\u5F0F\u4E2D");return}let t=ot();if(!t){console.error("[Videoo Notee] \u627E\u4E0D\u5230\u89C6\u9891\u64AD\u653E\u5668");return}y={element:t,parent:t.parentElement,nextSibling:t.nextSibling,originalStyles:{position:t.style.position,width:t.style.width,height:t.style.height,top:t.style.top,left:t.style.left,zIndex:t.style.zIndex}},S=rt(),S.querySelector(".vn-focus-video-area").appendChild(t),document.body.appendChild(S),document.body.style.overflow="hidden",M=!0,console.log("[Videoo Notee] \u8FDB\u5165\u89C6\u9891\u6A21\u5F0F"),window.postMessage({type:"VN_FOCUS_MODE_ENTERED"},"*")}function A(){if(!M||!y)return;let t=y.element;y.nextSibling?y.parent.insertBefore(t,y.nextSibling):y.parent.appendChild(t);let e=y.originalStyles;t.style.position=e.position,t.style.width=e.width,t.style.height=e.height,t.style.top=e.top,t.style.left=e.left,t.style.zIndex=e.zIndex,S&&(S.remove(),S=null),document.body.style.overflow="",y=null,M=!1,console.log("[Videoo Notee] \u9000\u51FA\u89C6\u9891\u6A21\u5F0F"),window.postMessage({type:"VN_FOCUS_MODE_EXITED"},"*")}function rt(){let t=document.createElement("div");t.className="vn-focus-mode-container",t.innerHTML=`
    ...
    `;let e=document.createElement("style");return e.textContent=st(),t.appendChild(e),it(t),t}function it(t){let e=t.querySelector(".vn-focus-close"),o=t.querySelector(".vn-focus-speed-down"),n=t.querySelector(".vn-focus-speed-up"),i=t.querySelector(".vn-focus-speed-display"),r=t.querySelector(".vn-focus-screenshot"),a=t.querySelector(".vn-focus-gutter"),c=t.querySelector(".vn-focus-video-area"),d=t.querySelector(".vn-focus-editor-area");e.addEventListener("click",A),o.addEventListener("click",()=>{let s=Le();s&&(s.playbackRate=Math.max(.25,s.playbackRate-.25),i.textContent=s.playbackRate.toFixed(2)+"x")}),n.addEventListener("click",()=>{let s=Le();s&&(s.playbackRate=Math.min(4,s.playbackRate+.25),i.textContent=s.playbackRate.toFixed(2)+"x")}),r.addEventListener("click",()=>{window.postMessage({type:"VN_CAPTURE_SCREENSHOT"},"*")});let l=!1;a.addEventListener("mousedown",s=>{l=!0,s.preventDefault()}),document.addEventListener("mousemove",s=>{if(!l)return;let u=t.getBoundingClientRect(),m=(s.clientX-u.left)/u.width*100,b=Math.min(80,Math.max(20,m));c.style.flex=`0 0 ${b}%`,d.style.flex=`0 0 ${100-b-1}%`}),document.addEventListener("mouseup",()=>{l=!1}),document.addEventListener("keydown",s=>{s.key==="Escape"&&M&&A()})}function Le(){return S?S.querySelector("video"):document.querySelector("video")}function st(){return`
    ...
    `}function Te(){return M}var p=null,I=null;async function at(){console.log("[Videoo Notee] \u5185\u5BB9\u811A\u672C\u521D\u59CB\u5316...");let t=window.location.href;if(_.match(t))p=new _,D.registerProvider("youtube",new P);else if(z.match(t))p=new z,D.registerProvider("bilibili",new O);else{console.log("[Videoo Notee] \u672A\u8BC6\u522B\u7684\u5E73\u53F0");return}await p.init(),ct(),$.runtime.onMessage.addListener(mt),window.addEventListener("message",pt),console.log("[Videoo Notee] \u5185\u5BB9\u811A\u672C\u521D\u59CB\u5316\u5B8C\u6210")}function ct(){I&&I.remove(),I=document.createElement("div"),I.id="videoo-notee-toolbar",I.innerHTML=`
  ...
  `,document.head.appendChild(t),document.body.appendChild(I),document.getElementById("vn-screenshot").addEventListener("click",Ne),document.getElementById("vn-note").addEventListener("click",Ce),document.getElementById("vn-focus").addEventListener("click",Me),document.getElementById("vn-subtitle").addEventListener("click",lt),document.addEventListener("keydown",ut)}async function Ne(){let t=p==null?void 0:p.getVideoElement();if(!t){x("\u672A\u627E\u5230\u89C6\u9891\u5143\u7D20");return}try{let e=await F(t),o=p.getVideoInfo();await $.runtime.sendMessage({type:"SAVE_SCREENSHOT",data:{screenshot:e.dataUrl,timestamp:e.timestamp,videoUrl:o.url,videoTitle:o.title}}),x(`\u5DF2\u622A\u56FE ${j(e.timestamp)}`)}catch(e){console.error("[Videoo Notee] \u622A\u56FE\u5931\u8D25:",e),x("\u622A\u56FE\u5931\u8D25: "+e.message)}}function Ce(){H()}function Me(){Te()?A():(ne(),setTimeout(()=>{H()},100))}async function lt(){let t=window.location.href,e=D.detectProvider(t);if(!e){x("\u5F53\u524D\u5E73\u53F0\u6682\u4E0D\u652F\u6301\u5B57\u5E55\u63D0\u53D6");return}try{let o=await e.getAvailableSubtitles();if(o.length===0){x("\u672A\u627E\u5230\u53EF\u7528\u5B57\u5E55");return}dt(o,e)}catch(o){console.error("[Videoo Notee] \u83B7\u53D6\u5B57\u5E55\u5931\u8D25:",o),x("\u83B7\u53D6\u5B57\u5E55\u5931\u8D25")}}function dt(t,e){let o=document.getElementById("vn-subtitle-menu");o&&o.remove();let n=document.createElement("div");n.id="vn-subtitle-menu",n.style.cssText=`
    position: fixed;
    bottom: 140px;
    right: 70px;
  ...
  `,t.forEach(r=>{let a=document.createElement("div");a.style.cssText=`
      ...
      cursor: pointer;
      transition: background 0.2s;
    `,a.textContent=`${r.label}${r.isAuto?" (\u81EA\u52A8)":""}`,a.addEventListener("mouseover",()=>a.style.background="rgba(255,255,255,0.1)"),a.addEventListener("mouseout",()=>a.style.background="transparent"),a.addEventListener("click",async()=>{n.remove();let c=await e.getSubtitle(r.id),d=e.toPlainText(c);await $.runtime.sendMessage({type:"SUBTITLE_LOADED",data:{entries:c,text:d,language:r.language}}),x(`\u5DF2\u52A0\u8F7D\u5B57\u5E55: ${r.label}`)}),n.appendChild(a)}),document.body.appendChild(n);let i=r=>{n.contains(r.target)||(n.remove(),document.removeEventListener("click",i))};setTimeout(()=>document.addEventListener("click",i),100)}function ut(t){t.altKey&&t.key==="s"&&(t.preventDefault(),Ne()),t.altKey&&t.key==="n"&&(t.preventDefault(),Ce()),t.altKey&&t.key==="f"&&(t.preventDefault(),Me())}async function pt(t){if(t.source!==window)return;let{type:e,data:o}=t.data;switch(e){case"VN_CAPTURE_SCREENSHOT":await ft();break;case"VN_GET_TIMESTAMP":let n=p==null?void 0:p.getVideoElement(),i=(p==null?void 0:p.getVideoInfo())||{};n&&window.postMessage({type:"VN_TIMESTAMP_RESULT",data:{timestamp:n.currentTime,videoUrl:i.url}},"*");break;case"VN_ENTER_FOCUS_MODE":ne();break;case"VN_EXIT_FOCUS_MODE":A();break}}async function ft(){let t=p==null?void 0:p.getVideoElement();if(!t){x("\u672A\u627E\u5230\u89C6\u9891\u5143\u7D20");return}try{let e=await F(t),o=p.getVideoInfo();await $.runtime.sendMessage({type:"SAVE_SCREENSHOT",data:{screenshot:e.dataUrl,timestamp:e.timestamp,videoUrl:o.url,videoTitle:o.title}}),ye(e.dataUrl,e.timestamp,o.url),x(`\u5DF2\u622A\u56FE ${j(e.timestamp)}`)}catch(e){console.error("[Videoo Notee] \u622A\u56FE\u5931\u8D25:",e),x("\u622A\u56FE\u5931\u8D25: "+e.message)}}async function mt(t,e,o){switch(t.type){case"CAPTURE_VIDEO_FRAME":let n=p==null?void 0:p.getVideoElement();if(n){let r=await F(n);o(r)}else o({error:"\u672A\u627E\u5230\u89C6\u9891\u5143\u7D20"});break;case"GET_VIDEO_INFO":o((p==null?void 0:p.getVideoInfo())||{});break;case"SEEK_TO":let i=p==null?void 0:p.getVideoElement();i&&t.data.time!==void 0?(i.currentTime=t.data.time,o({success:!0})):o({error:"\u65E0\u6CD5\u8DF3\u8F6C"});break}return!0}function x(t,e=2e3){let o=document.createElement("div");o.className="vn-toast",o.textContent=t,document.body.appendChild(o),setTimeout(()=>{o.style.opacity="0",o.style.transform="translateY(-10px)",setTimeout(()=>o.remove(),300)},e)}at();
